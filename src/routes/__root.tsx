...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "apple-mobile-web-app-title", content: "Family COO" },
      { name: "mobile-web-app-capable", content: "yes" },
      { name: "application-name", content: "Family COO" },
      { name: "format-detection", content: "telephone=no" },
      { property: "og:site_name", content: "Family COO" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "google-site-verification", content: "T70YnPpOfRJW0oouON6qMjpfAkCYuE3EnNxiWKNZz6o" },
    ],
    links: [
      ...
      { rel: "mask-icon", href: "/icon-512.png", color: "#2563EB" },
